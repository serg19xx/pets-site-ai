# Social groups outreach (founding beta)

Цель: мягко набрать **founding testers** в локальных pet-группах (FB / Discord / Reddit), не спамить.

**Invite (везде один):** https://pb.websmith-shop.com/invite  
**Коллаж для вложения:** [`marketing/beta-collage-square.png`](./marketing/beta-collage-square.png) (FB) · [`marketing/beta-collage-instagram.png`](./marketing/beta-collage-instagram.png) (IG)

Черновики по углам: [`beta-social-posts.md`](./beta-social-posts.md)
...
| Query | Заметка |
|-------|---------|
| `chiens Montréal` / `dogs Montreal` | владельцы собак |
| `chats Montréal` / `cats Montreal` | владельцы кошек |
| `animaux Montréal` / `pet owners Montreal` | общее |
| `adoption animaux Montréal` | осторожно: не продавать, только soft beta |
| `Laval chiens` / `Rive-Sud animaux` | suburbs |
| `lost pets Montreal` | **не постить** — только помощь, не промо |

Reddit (мягче, часто нужен коммент без ссылки сначала):  
`r/montreal`, `r/Quebec`, pet subs — читай правила self-promo.

Instagram: Stories + пост с коллажом; в bio можно `/invite`.

## Трекер постов

| Date | Channel | Group / page | Post # | Status | Notes |
|------|---------|--------------|--------|--------|-------|
| 12-08-2026 | FB | ~30 pet groups (MTL / QC / mixed) | 3 FR+EN | posted | Коллаж + один блок (ссылка + FR + EN). 13-08: пока тишина — проверить, не в pending у модераторов |
|      | IG      | own profile  | collage| todo   |       |

Статусы: `todo` · `posted` · `removed` · `banned_risk` (правила запрещают — не трогать)

## План на сейчас

1. [x] Найти живые FB-группы MTL/QC
2. [x] Разослать пост #3 (~30 групп) + коллаж
3. [ ] 2–3 дня: смотреть комменты / удаления модераторами, не дублировать те же группы
4. [ ] Не раньше чем через 2–3 недели — мягкий reminder только в группах, где пост живой и был интерес
5. [ ] Instagram: свой профиль + Stories (коллаж)
